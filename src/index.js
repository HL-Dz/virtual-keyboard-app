...
import { get } from './js-modules/local-storage/storage.js';
import Keyboard from './js-modules/keyboard/Keyboard.js';
...
new Keyboard(linesOrder).init(lang).generateKeyboardLayout();